...
function make(producer) {
  var onMessage = function (receipt) {
    ...
    var widgetCondition = Belt_Option.getExn(Curry._1(Grpc.Assemblyline[/* BlankWidget */2][/* conditionGet */1], blankWidget));
    console.log("cutting widget...");
    return Mock.cutWidget((function (widgetCondition, numTeeth) {
                  var cutWidget = Curry._3(Grpc.Assemblyline[/* CutWidget */3][/* make */2], widgetCondition, numTeeth, /* () */0);
