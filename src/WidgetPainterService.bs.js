...
function make(producer) {
  var onMessage = function (receipt) {
    ...
    var condition = Belt_Option.getExn(Curry._1(Grpc.Assemblyline[/* CutWidget */3][/* condition */1], cutWidget));
    ...
    return Mock.paintWidget((function (condition, paintJob) {
                  var paintedWidget = Curry._4(Grpc.Assemblyline[/* PaintedWidget */5][/* make */3], /* Some */[condition], /* Some */[numTeeth], /* Some */[paintJob], /* () */0);
